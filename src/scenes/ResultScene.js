...
import { GAME_W, GAME_H, GRADES, STORAGE_KEY, MENTAL_MAX } from '../config.js';
...
export class ResultScene extends Phaser.Scene {
  ...
  create() {
    ...
    if (isBest) localStorage.setItem(STORAGE_KEY, String(finalScore));
    ...
    this.add
      .text(GAME_W / 2, 1170, '타이틀로', { fontFamily: FONT, fontSize: '36px', fontStyle: 'bold', color: '#d8cfec' })
      .setOrigin(0.5);
    home.on('pointerdown', () => this.scene.start('Title'));
  }
